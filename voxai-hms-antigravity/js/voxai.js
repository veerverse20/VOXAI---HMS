// Copy of voxai.js in the js directory
// Include the exact same module code to maintain complete compatibility
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const runVoiceCommand = () => {
    ...
    if (bookMatch) {
      ...
      const matchedDoc = doctors.find(d => d.name.toLowerCase().includes(docName.toLowerCase())) || doctors[1];
